...
echo *** REGISTRY EDITOR (regchg.bat, running w/Admin Permissions) - latest utility will be located on the Lan Internet GitHub (https://github.com/laninternet/Soft/BatchUtil/regchg.bat) ***
