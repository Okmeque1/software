...
flag = True
while flag == True:
    print("****THE OKMEQUE1 PASSWORD SECURITY SYSTEM****")
    ...
    if option == 1:
        ...
        for pwd in range(number):
            ...
            set0 = input("Enter a name or nothing to continue this program.This program does NOT support having 2 sets of the same name.Entering a name that already exists will cause a conflict.")
            passave = open("G:/Python/Demo/PASSWORD.TXT","a")
